...
import { homeScrollChapters, capabilitySectionCopy } from '../../data/homeScrollChapters.js';
import { FieldNarrativeProvider } from '../../context/FieldNarrativeContext.jsx';
import { ScrollOrchestratorProvider } from '../../context/ScrollOrchestratorContext.jsx';
...
import { OpeningMobile } from '../mobile/OpeningMobile.jsx';
import { CapabilitiesMobile } from '../mobile/CapabilitiesMobile.jsx';
import { WorkMobile } from '../mobile/WorkMobile.jsx';
import { PovMobile } from '../mobile/PovMobile.jsx';
...
function HomeScrollInner() {
  ...
  if (isMobileHome) {
    return (
      <div className="home-scroll home-scroll--mobile">
        <HeaderMobile />
        <ProjectPasswordModal />
        <NarrativeChapter
          id="home-landing"
          sectionClassName="home-hero home-hero--mobile"
          chapterNum="01"
        ...
        <NarrativeChapter
          ...
          sectionClassName="cap-dial-chapter cap-dial-chapter--mobile"
          chapterNum="02"
          chapterLabel={capabilitySectionCopy.title}
          ambientKey="signal"
          ariaLabel={capabilitySectionCopy.title}
        >
          <CapabilitiesMobile />
        </NarrativeChapter>
        <NarrativeChapter
          ...
          sectionClassName="work-narrative-chapter work-narrative-chapter--mobile"
          chapterNum="03"
          chapterLabel="Work"
          ambientKey="work"
          ariaLabel="Work"
        >
          <WorkMobile cases={homeScrollChapters} />
        </NarrativeChapter>
        <NarrativeChapter
          id="home-approach"
          guideTargetId="point-of-view"
          sectionClassName="home-pov home-pov--mobile"
          chapterNum="04"
        ...
        <NarrativeChapter
          ...
          guideTargetId="me"
          sectionClassName="home-life-archive home-life-archive--mobile"
          chapterNum="05"
...
function HomeScrollRootLayout() {
  ...
  const { registerScrollRoot, scrollReady, fieldReady } = useScrollOrchestrator();

  useLayoutEffect(() => {
    registerScrollRoot(scrollRootRef.current);
  ...
  useLayoutEffect(() => {
    ...
    if (root.dataset.openingHandoff === 'active') {
      delete root.dataset.openingBootActive;
    }
    ...
    observer.observe(root, { attributes: true, attributeFilter: ['data-opening-handoff'] });
  ...
  return (
    ...
    >
      ...
      <HomeScrollInner />
      {!isMobileHome ? <ViewportOrganicField /> : null}
      {!isMobileHome ? <PovSourcesDock /> : null}
      <PortfolioShortcut />
    </div>
  );
}
